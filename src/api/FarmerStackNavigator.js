...
const FarmerStackNavigator = () => (
  ...
  >
    ...
    <Stack.Screen name="Accounts" component={AccountScreen} options={{ headerShown: true }} />
    <Stack.Screen name="Billing" component={BillingScreen} options={{ headerShown: true }} />
    <Stack.Screen name="Messaging" component={MessagingScreen} options={{ headerShown: true }} />
    <Stack.Screen name="Market" component={MarketScreen} options={{ headerShown: true }} />
    <Stack.Screen name="Store" component={StoreScreen} options={{ headerShown: true }} />
    <Stack.Screen name="Education" component={ChatGPT} options={{ headerShown: true }} />
    <Stack.Screen name="RequestVet" component={VetRequestScreen} options={{ headerShown: true }} />
    <Stack.Screen name="MilkRecords" component={MilkRecordsScreen} options={{ headerShown: true }} />
    <Stack.Screen name="MilkDetail" component={MilkDetailScreen} options={{ headerShown: true }} />
    <Stack.Screen name="FinancialOverview" component={FinancialOverviewScreen} options={{ headerShown: true }} />
    <Stack.Screen name="FinancialDetails" component={FinancialDetailsScreen} options={{ headerShown: true }} />
    ...
    <Stack.Screen name="AllAnimals" component={AllAnimalsScreen} options={{ headerShown: true }} />
    <Stack.Screen name="AddPost" component={AddPostScreen} options={{ headerShown: true }} />
    <Stack.Screen name="AnimalDetails" component={AnimalDetailsScreen} options={{ headerShown: true }} />
  </Stack.Navigator>
);
