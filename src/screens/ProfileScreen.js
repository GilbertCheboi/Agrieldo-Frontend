...
//         date: selectedDate,
//         productionDetails: milkRecords[selectedDate],
//       });
//     } else {
//       Alert.alert(
//         'No records',
//         `No milk production records found for ${selectedDate}`,
//       );
//     }
//   };
...
//         ' http://192.168.100.4:8000/api/profiles/farmer/profile/',
//         formData,
//         {
//           headers: {
//             'Content-Type': 'multipart/form-data',
...
//             <Text style={[styles.cell, styles.headerCell, styles.dateColumn]}>
//               Date
//             </Text>
...
//               onChangeText={text =>
//                 setUpdatedProfile({...updatedProfile, first_name: text})
//               }
//             />
//             <TextInput
//               style={{borderBottomWidth: 1, marginVertical: 10}}
...
//               onChangeText={text =>
//                 setUpdatedProfile({...updatedProfile, second_name: text})
//               }
//             />
//             <TextInput
//               style={{borderBottomWidth: 1, marginVertical: 10}}
...
//               onChangeText={text =>
//                 setUpdatedProfile({...updatedProfile, phone_number: text})
//               }
//             />
//             <TextInput
//               style={{borderBottomWidth: 1, marginVertical: 10}}
...
//               onChangeText={text =>
//                 setUpdatedProfile({...updatedProfile, farm_location: text})
//               }
//             />
//             <TouchableOpacity
//               onPress={handleImagePick}
...
const ProfileScreen = () => {
  ...
  const totalAnimals = profile?.farms?.reduce(
    (sum, farm) => sum + (farm.animals?.length || 0),
    0,
  );
  ...
  const handleSelectCover = () => {
    ...
    launchImageLibrary(options, async response => {
      if (response.didCancel) {
        ...
        console.log('Selected Cover Image URI:', uri);

        // Update locally for preview
        setProfile(prev => ({...prev, cover_image: uri}));

        try {
          await updateCoverImage(uri);
          console.log('Cover image saved to DB');
        } catch (error) {
  ...
  if (!profile) return <Text style={styles.loading}>No profile found</Text>;
    ...
    <ScrollView
        ...
        <Image
          source={{
            uri: profile.cover_image
              ? profile.cover_image.startsWith('http') ||
                profile.cover_image.startsWith('file')
                ? profile.cover_image
                : ` http://192.168.100.4:8000${profile.cover_image}`
          ...
          source={{
            uri: profile.profile_image
              ? profile.profile_image.startsWith('http')
                ...
                : ` http://192.168.100.4:8000${profile.profile_image}`
      ...
      <View style={styles.actionButtons}>
        <TouchableOpacity style={styles.activeTab}>
          <Text style={styles.tabTextActive}>Production</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.inactiveTab}>
          <Text style={styles.tabText}>My Animals</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.inactiveTab}>
      ...
      <Card style={styles.card}>
        <View style={styles.tableHeader}>
          ...
          <Text style={styles.tableHeaderText}>Milk</Text>
          <Text style={styles.tableHeaderText}>Eggs</Text>
          <Text style={styles.tableHeaderText}>Weight</Text>
        </View>

        {/* Example rows */}
        <View style={styles.tableRow}>
          <Text style={styles.tableCell}>2024-12-18</Text>
          <Text style={styles.tableCell}>Morning</Text>
        ...
        <View style={styles.tableRow}>
          <Text style={styles.tableCell}>2024-12-18</Text>
          <Text style={styles.tableCell}>Afternoon</Text>
          <Text style={styles.tableCell}>0</Text>
        ...
        <View style={styles.tableRow}>
          <Text style={styles.tableCell}>2024-12-18</Text>
          <Text style={styles.tableCell}>Evening</Text>
        ...
        <View style={styles.tableTotal}>
          ...
          <Text style={styles.tableTotalText}>25.00</Text>
          <Text style={styles.tableTotalText}>265.00</Text>
          <Text style={styles.tableTotalText}>0.00</Text>
        </View>
      </Card>
      ...
      <View style={styles.dangerZone}>
        ...
        <Text style={styles.dangerDescription}>
          Deleting your account will permanently remove all your farms, animals,
...
const styles = StyleSheet.create({
  ...
  statsContainer: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    gap: 40, // ✅ even spacing between items (works RN 0.71+)
    marginTop: 10,
  },
  statBox: {
    alignItems: 'center',
  ...
  infoContainer: {
    ...
    alignItems: 'center',
    marginTop: 40, // ✅ pushes both info + button lower
    marginLeft: 15,
    marginRight: 15,
  },
  ...
  profileSection: {
    flexDirection: 'row',
    alignItems: 'center',
    marginTop: -50, // avatar overlaps cover
  ...
  profileInfo: {
    marginTop: 15, // ✅ increase this to lower the text block
    marginLeft: 15,
  },
  ...
  card: {marginHorizontal: 10, padding: 10, borderRadius: 10},
  ...
  tableTotalText: {fontWeight: 'bold', flex: 1, textAlign: 'center'},
  ...
  dangerDescription: {fontSize: 14, color: '#cc0000', marginBottom: 15},
  deleteButton: {marginVertical: 10, borderRadius: 25},
  coverContainer: {
    position: 'relative',
  },
  coverImage: {
