      ...
      try {
        ...
        if (error.response) {
          if (error.response.status === 400) {
            alert(
              'Please check the content and image. There might be an issue with the input format.',
            );
      ...
      <Modal
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity
              onPress={() => handleActionSelect('createPost')}
              style={styles.actionButton}>
              <Text style={styles.actionButtonText}>Create Post</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => handleActionSelect('viewReports')}
              style={styles.actionButton}>
              <Text style={styles.actionButtonText}>View Reports</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => handleActionSelect('requestVet')}
              style={styles.actionButton}>
      ...
      <Modal
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity
              onPress={() => setVetRequestModalVisible(false)}
              style={styles.closeButton}>
              <Text style={styles.closeButtonText}>Close</Text>
            </TouchableOpacity>
          </View>
